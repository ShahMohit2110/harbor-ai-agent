...
##############################################################################
# Harbor Agent Automatic Tracker - Wrapper Script
##############################################################################
#
# This script starts the automatic tracker that monitors agent work
# and updates the ticket tracker in real-time.
#
# Usage: ./auto-tracker.sh [start|stop|status|check|logs]
#
##############################################################################
...
TRACKER_SCRIPT="${SCRIPT_DIR}/automatic-tracker.js"
...
print_header() {
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${CYAN}  Harbor Agent Automatic Tracker${NC}"
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
}
...
start_tracker() {
    ...
    print_info "Starting automatic tracker..."
    echo ""
    ...
    if ps -p $pid > /dev/null 2>&1; then
        print_success "Automatic tracker started successfully"
        echo ""
        print_info "PID: $pid"
        print_info "Log file: $LOG_FILE"
        echo ""
        print_info "The tracker will now:"
        echo "  • Monitor active tickets"
        echo "  • Detect Git commits automatically"
        ...
        echo ""
        print_success "Tracker is now running!"
    else
...
show_status() {
    ...
    if is_running; then
        local pid=$(cat "$PID_FILE")
        print_success "Automatic tracker is running"
        echo ""
        echo "PID: $pid"
...
case "${1:-status}" in
    ...
    *)
        echo "Usage: $0 [start|stop|status|logs|check|restart]"
        echo ""
        echo "Commands:"
        echo "  start   - Start automatic tracking"
