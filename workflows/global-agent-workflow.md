...
- 🤖 **Fully Autonomous Execution** - NO questions, NO pauses, complete autonomy
- ✅ **Evidence-Based Validation** - MUST have file proof for all claims
- 🧠 **Implicit Requirement Inference** - Agent thinks like a senior engineer who infers system requirements
- 🔴 **Model → Database Obligation Rule** - Automatically detects when models need database sync registration
- 🔄 **Model Lifecycle Awareness** - Enforces complete lifecycle from definition to database table
...
# 🚀 12-PHASE AUTONOMOUS EXECUTION PROTOCOL (MANDATORY)
...
- DO NOT proceed until documentation is complete

**IF `/docs` IS PARTIAL OR OUTDATED:**
...
5. **MODEL_FLOW.md** (CRITICAL - NEW)
   - Data flow: controller → service → repository → DB
   - Model lifecycle
   - Validation and transformation logic

6. **API_PATTERNS.md** (IF APPLICABLE)
   - Request/response format
   - Error handling patterns

7. **AUTH.md** (IF APPLICABLE)
   - Authentication & authorization flow
   - Middleware and guards

8. **SERVICE_RULES.md** (CRITICAL)
   - Inter-service communication rules
   - DOs and DON'Ts
   - Service boundaries

9. **SHARED_SERVICES.md** (CRITICAL - NEW)
   - List of shared services/packages
   - How they are used
   - Dependency relationships
   - Impact of changes

10. **CHANGE_IMPACT.md** (CRITICAL - NEW)
...
- ✅ Documentation reflects actual code (not assumptions)
- ✅ Cross-service relationships are accurate
- ✅ Model flow is completely documented
- ✅ Shared service dependencies are listed
- ✅ Change impact is understood
- ✅ All rules and constraints are documented
...
**🚨 After documentation gate passes, perform deep repository analysis.**
...
### Step 1.3: Deep Repository Analysis
...
- Service name
- Service purpose
- Microservice or shared package
- Entry point
- Language & framework
...
#### D. DEPENDENCIES ANALYSIS
- package.json / composer.json / requirements.txt
- Build scripts (build/start/publish)
- Internal/shared packages
- External dependencies
- Version constraints

#### E. DATABASE ANALYSIS (IF APPLICABLE)
- Database type (MSSQL, MongoDB, PostgreSQL, etc.)
- ORM (Sequelize, TypeORM, Prisma, etc.)
- Schema structure
- Relationships and foreign keys
- Migration strategy

#### F. AUTH SYSTEM (IF APPLICABLE)
...
#### H. SHARED SERVICE DETECTION (VERY IMPORTANT)

**Identify if this repository is:**
- A **shared/common service** (e.g., common-utils, shared-models)
- A **consumer** of shared services

**For shared services, identify:**
- Which services depend on this service
- How it's consumed (import, API, etc.)
- Version constraints (if any)
- Breaking change potential

**For service consumers, identify:**
- Which shared services are used
- Import patterns
- Dependency versions

### Step 1.4: Architecture Detection
...
- Centralized src/ and single package.json

👉 **Action:** ACTIVATE Direct Local Execution Mode

### Step 1.5: Output Requirements

**After analysis, MUST provide:**

1. **Repository Inventory**
   - All repositories detected
   - Their purposes and roles
...
3. **Dependency Map**
   - Which services depend on whom
   - Shared services and their consumers

4. **Model Flow Documentation**
...
**🚨 CRITICAL: Understand service relationships before planning execution.**

**Based on repository analysis, build comprehensive understanding of:**

### Step 2.1: Dependency Mapping

**Create complete dependency graph:**

1. **Upstream Dependencies**
   - Which services does this repository depend on?
   - What shared packages are consumed?
   - External service dependencies

2. **Downstream Dependents**
   - Which services depend on this repository?
   - Who consumes this service's APIs/models?
   - Impact radius of changes

3. **Peer Dependencies**
   - Services that share common dependencies
   - Potential for shared state or conflicts

### Step 2.2: Shared Service Classification

**For each shared service detected:**

1. **Mark as HIGH-IMPACT**
   - Changes affect multiple services
   - Requires careful coordination
   - Breaking changes have system-wide impact

2. **Identify Consumption Patterns**
   - How is it imported/used?
   - What APIs/models are exposed?
   - What contracts must be maintained?

3. **Version Strategy** (if applicable)
   - How are versions managed?
   - Compatibility requirements
   - Deprecation policies

### Step 2.3: Change Propagation Analysis

**Before implementing changes:**

1. **If modifying shared logic:**
   - ✅ Identify ALL impacted services
   - ✅ Ensure backward compatibility
   - ✅ Avoid breaking changes
   - ✅ Coordinate updates if needed

2. **If modifying consumer service:**
   - ✅ Check if shared service updates are needed
   - ✅ Verify version compatibility
   - ✅ Update imports/references

3. **If adding new shared logic:**
   - ✅ Follow existing patterns
   - ✅ Document properly
   - ✅ Consider all consumers

### Step 2.4: Service Boundary Enforcement
...
1. **NEVER access another service's database directly**
   ...
   - No direct DB queries across services

2. **NEVER bypass shared services**
   - Use common utilities
   - Don't duplicate code
   - Follow established patterns

3. **ALWAYS maintain contracts**
   - API contracts must be stable
   - Model changes must be backward compatible
   - Document breaking changes

### Step 2.5: Impact Prediction

**For planned changes, predict:**

1. **Impact Level**
   - **LOW**: Single service, no shared logic
   - **MEDIUM**: Multiple services, shared models
   - **HIGH**: Shared services, system-wide changes

2. **Affected Services**
   - List all services that will be impacted
...
### Step 2.6: Safe Change Guidelines

**For each impact level:**

**LOW Impact:**
- ✅ Can proceed with standard implementation
- ✅ Standard testing applies

**MEDIUM Impact:**
- ✅ Plan updates to dependent services
- ✅ Ensure backward compatibility
...
### Step 2.7: Output Requirements

**After cross-service analysis, MUST provide:**
...
2. **Shared Service Inventory**
   - All shared services and their consumers
...
**🚨 If /docs is missing or incomplete, generate comprehensive documentation.**

**Based on analysis and cross-service intelligence, generate:**

### Step 3.1: Documentation Status Assessment

**Check current state:**

1. **If /docs exists and is complete:**
   - ✅ Verify accuracy against analysis
   - ✅ Update if needed
   - ✅ Skip to Phase 4

2. **If /docs missing or incomplete:**
   - 🚨 Generate ALL required files
   - 🚨 Block execution until complete

### Step 3.2: Generate Required Documentation Files

**Create/update each file with analysis findings:**
...
- Type: [Microservice/Shared Package/Monolith Module]
...
## External Dependencies
[List from package.json with purposes]

## Internal Dependencies
[Shared packages and services used]
...
## Database Type
- Type: [MSSQL/MongoDB/PostgreSQL/etc]
...
Controller → Service → Repository → Database
    ↓         ↓          ↓           ↓
  Validate  Transform  Query    Return Data
    ↓         ↓          ↓           ↓
  Response  Response  Result    Entity
```

### Model Lifecycle
1. **Definition**: Where models are defined
2. **Validation**: How validation happens
3. **Transformation**: Data transformation logic
4. **Persistence**: How data is stored
5. **Retrieval**: How data is retrieved

### Detailed Flow

#### Example: [EntityName] Flow
1. **Controller Layer**
...
[If this is a consumer]

| Service | Purpose | Version | Usage |
|---------|---------|---------|-------|
| [Name] | [Purpose] | [Version] | [How used] |

## Service Consumers
[If this is a shared service]

| Service | How Used | Impact |
|---------|----------|--------|
| [Name] | [Usage pattern] | [High/Medium/Low] |
...
## Service Impact Level: [LOW/MEDIUM/HIGH]

### Impact Assessment
- **Scope**: [What this service affects]
...
|---------|-------------|----------|
| [Name] | [API/Model/Behavior] | [High/Medium/Low] |

#### Impact Categories
1. **API Changes**: [What API changes would affect]
2. **Model Changes**: [What model changes would affect]
3. **Behavior Changes**: [What behavior changes would affect]
...
## 🚫 PROHIBITED ACTIONS
- ❌ DO NOT push code (autonomous mode)
...
### Step 3.3: Documentation Validation

**Before proceeding to Phase 4:**

- ✅ All required files exist
- ✅ Content is accurate (matches analysis)
- ✅ Cross-references are correct
- ✅ No assumptions without evidence
- ✅ Documentation is readable and clear

### Step 3.4: Documentation Output
...
4. **Ready for Phase 4 (Execution Planning)**
...
## 🔗 Phase 10: Dependency Integrity Check (MANDATORY)
...
## 🤖 Phase 11: Fully Autonomous Execution (MANDATORY)
...
## ✅ Phase 12: Evidence-Based Validation (MANDATORY)
...
# 🏗️ DETAILED ANALYSIS PROTOCOLS (SUPPLEMENTARY)

**This section provides detailed protocols that supplement the 12-phase workflow above.**

## 🏁 Environment Detection & Architecture Analysis (DETAILED)
